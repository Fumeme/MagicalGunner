...
import MagicalMod.powers.CommonPower;

public class DefaultCommonPower extends AbstractCorrCard {
    ...
    public static final String ID = MagicalBase.makeID("DefaultCommonPower");
